                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label class="field select">
                                                {!! Form::select('column', \App\Http\Helper\Helper::getEmployeeDropDown(),$column) !!}
                                        ...
                                        <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                            ...
                                            @foreach($emps as $emp)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{App\Http\Helper\Helper::convertStatusBack
                                                    ($emp->employee['status'])}}</td>
